...
/* @file sapi_bme280.c
 * @brief Sensor sAPI for BME280 sensor. The packege contains:
 * sapi_bme280.c and sapi_bme280.h
 */
/*==================[inclusions]=============================================*/
#include "sma.h"
#include "sapi.h"		// <= sAPI header
#include "sapi_bme280.h"        /* <= sAPI BME280 header */
...
#else
	uartWriteString(UART_USB, "Falta");
#endif
}
